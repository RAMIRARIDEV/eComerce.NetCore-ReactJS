...
import Cargastock from './views/CargaStock'

import UserProvider from "./context/UserProvider"
import VerificarUsuario from './views/Shared/VerificarUsuario';
        ...
        <UserProvider>
            <Routes>
                ...
                <Route path='/' element={<App />}>
                    ...
                    <Route path='cargastock' element={<VerificarUsuario > <Cargastock /> </VerificarUsuario>} />
