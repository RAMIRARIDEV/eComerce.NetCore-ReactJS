...
using DtoProducto = ReactVentas.Models.DTO.DtoProducto;
    ...
    public class VentaController : ControllerBase
    {
        ...
        public IActionResult Registrar([FromBody] DtoVenta request) {
            try
            {
                ...
                foreach (Models.DTO.DtoProducto item in request.listaProductos)
                {
                    productos.Add(new XElement("Item",
                        new XElement("IdProducto", item.IdProducto),
                        new XElement("Cantidad", item.Cantidad),
                        new XElement("PrecioVenta", item.PrecioCompra),
                    ...
                    lista_venta = await _context.Venta
                        ...
                        .Select( v=> new DtoHistorialVenta() { 
                            ...
                            Detalle = v.DetalleVenta.Select( d => new DtoDetalleVenta() { 
                                Producto = d.IdProductoNavigation.Marca + " " + d.IdProductoNavigation.Descripcion,
                                Cantidad = d.Cantidad.ToString(),
                                PrecioVenta = Convert.ToInt32(d.Total / d.Cantidad).ToString(),
                    ...
                    lista_venta = await _context.Venta
                        ...
                        .Select(v => new DtoHistorialVenta()
                        {
                            ...
                            Detalle = v.DetalleVenta.Select(d => new DtoDetalleVenta()
                            {
                                ...
                                Cantidad = d.Cantidad.ToString(),
                                PrecioVenta = (d.Total / d.Cantidad).ToString(),
                                Total = d.Total.ToString()
                            }).ToList()
                        }).ToListAsync();
                }
